...
int main() {
  ...
  // StarterTaskNode tests
  {
    ...
    StarterTaskNode<decltype(f1), Pack<int, int>, Pack<int, int>> tn1(move(f1),
                                                                      {1, 2});
    tn1.Run();
...

  {
    ...
    auto p2 =
        new TaskNode<decltype(f2), Pack<int, int>, Pack<int, int>>(move(f2));
    auto p3 =
        new TaskNode<decltype(f3), Pack<int, int>, Pack<int, int>>(move(f3));
    auto p4 = new TaskNode<decltype(f4), Pack<int, int>, Pack<>>(move(f4));
  ...
  int counter = 0;
  {
    TaskHolder SimpleTHolder;
    {
      ...
      StarterTaskNode<decltype(f2_1), Pack<int>, Pack<int>> g2_1(move(f2_1),
                                                                 {0});
      ...
      StarterTaskNode<decltype(f3_1), Pack<int, int, int>, Pack<int, int, int>>
          g3_1(f3_1, {1, 2, 3});
      TaskNode<decltype(f3_2), Pack<int, int, int>, Pack<int, int, int>> g3_2(
          f3_2);
      TaskNode<decltype(f3_3), Pack<int, int, int>, Pack<int, int, int>> g3_3(
          f3_3);
